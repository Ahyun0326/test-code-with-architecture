...
public class UserControllerTest {
  ...
  void 사용자는_인증_코드가_일치하지_않을_경우_권한_없음_에러를_내려준다() {
    ...
    // then
    assertThatThrownBy(() -> {
            testContainer.userController.verifyEmail(1, "aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");
    }).isInstanceOf(CertificationCodeNotMatchedException.class);
  }

  @Test
  void 사용자는_내_정보를_불러올_때_개인정보인_주소도_갇고_올_수_있다() {
    // given
    TestContainer testContainer = TestContainer.builder()
  ...
  void 사용자는_내_정보를_수정할_수_있다() {
    ...
    ResponseEntity<MyProfileResponse> result =
        testContainer.userController.updateMyInfo(
            "kok202@naver.com",
            UserUpdate.builder().address("Pangyo").nickname("kok202-n").build());
