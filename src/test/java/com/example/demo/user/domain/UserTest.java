...
import com.example.demo.common.mock.TestClockHolder;
import com.example.demo.common.mock.TestUuidHolder;
...
public class UserTest {
  ...
  public void 유효한_인증_코드로_계정을_활성화_할_수_있다() {
    ...
    // when
    user = user.certification("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab");
  ...
  public void 잘못된_인증_코드로_계정을_활성화_하려면_에러를_던진다() {
    ...
    // when
    // then
    assertThatThrownBy(() -> user.certification("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac"))
